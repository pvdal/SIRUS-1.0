    ...
    <body class="relative">
        ...
        <main>
                ...
                <div class="shadow-2xl drop-shadow-2xl mx-auto border-4 border-gray-700 rounded-xl overflow-hidden bg-white max-w-[1480px] relative z-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                        ...
                        <div class="text-center lg:text-left h-full">
                            <div class="flex flex-col items-center justify-center py-20 h-full bg-primary-blue rounded-lg px-5">
                                <x-authentication-card-logo size="140"/>
                                <h1 class="text-white mt-3 mb-0 text-[3.5rem] lg:text-[5rem] font-bold leading-tight">
                                    SIRUS
                                </h1>
                        ...
                        <div class="flex flex-col justify-between h-full px-5 p-10 md:py-24">
                            <div>
                            ...
                            <div class="w-auto max-w-[420px] max-h-[100px] mb-0">
                                <a class="text-white inline-flex items-center gap-3 px-5 p-5 md:px-8 py-2 bg-primary-blue border border-transparent rounded-lg font-semibold text-[15px] md:text-[20px] lg:text-[25px] uppercase tracking-widest hover:opacity-90 focus:opacity-90 active:strong-blue focus:outline-none focus:ring-2 focus:ring-secondary-blue focus:ring-offset-2 disabled:opacity-50 transition ease-in-out duration-150" href="@auth /calendar @else /login @endauth">
            ...
            <section
                ...
                style="background-image: url('/img/FATEC_Franco.jpg')"
            >
                <!-- overlay escuro -->
