                            ...
                            <div class="mb-8">
                                ...
                                <div class="overflow-x-auto shadow rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 transition duration-150 ease-in-out">
                                        <thead class="bg-gray-100 dark:bg-gray-700 transition duration-150 ease-in-out">
                                        <tr>
                                            <th class="px-6 py-3 text-left text-xs font-medium dark:text-gray-300 uppercase tracking-wider w-1/4 transition duration-150 ease-in-out">Critério</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium dark:text-gray-300 uppercase tracking-wider transition duration-150 ease-in-out">Insatisfatório</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium dark:text-gray-300 uppercase tracking-wider transition duration-150 ease-in-out">Regular</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium dark:text-gray-300 uppercase tracking-wider transition duration-150 ease-in-out">Bom</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium dark:text-gray-300 uppercase tracking-wider transition duration-150 ease-in-out">Excelente</th>
                                        </tr>
                                        </thead>
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700 transition duration-150 ease-in-out">
                                        <template x-for="criterion in axis.criteria" :key="criterion.id">
