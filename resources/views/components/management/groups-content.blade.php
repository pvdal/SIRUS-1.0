                        ...
                        <div class="min-w-full px-3 py-1">
                            <template x-if="group.papers.length">
                                <button
                                    ...
                                    x-on:click="showPaper(`${group.papers[group.papers.length -1].file_path}`)"
                                >
                                    <x-lucide-file-text class="w-4 h-4 text-gray-600 flex-shrink-0"/>
                                    <span class="text-sm text-gray-800 font-semibold truncate " x-text="group.papers[group.papers.length -1].title"></span>
