<div class="min-w-0 max-w-4xl w-full xl:pe-24" :class="{ {{ $textSettings }} }">
    {{-- Capítulo 12 --}}
    <h1 class="text-3xl font-bold mb-14 text-gray-900 dark:text-gray-100">12. Tokens de API</h1>

    {{-- Capítulo 12.1 --}}
    <h2 id="cap-12.1" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.1 O que são Tokens</h2>
    <p class="mb-10">
    ...
    {{-- Capítulo 12.2 --}}
    <h2 id="cap-12.2" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.2 Como gerar um Token</h2>
    <p class="mb-2">
    ...
    {{-- Capítulo 12.3 --}}
    <h2 id="cap-12.3" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.3 Como usar (Headers)</h2>
    <p class="mb-2">
    ...
    {{-- Capítulo 12.4 --}}
    <h2 id="cap-12.4" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.4 Rotas protegidas</h2>
    <p class="mb-2">
    ...
    <h3 id="cap-12.4-a" class="font-semibold mb-2 text-gray-900 dark:text-gray-100">Exemplos de rotas</h3>
    ...
    {{-- Capítulo 12.5 --}}
    <h2 id="cap-12.5" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.5 Permissões (Abilities)</h2>
    <p class="mb-10">
    ...
    {{-- Capítulo 12.6 --}}
    <h2 id="cap-12.6" class="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">12.6 Revogação de Token</h2>
    <p class="mb-2">
    ...
    <div class="mb-10 bg-red-50/60 dark:bg-red-900/10 border border-red-400/60 dark:border-red-500/50 rounded-lg p-4 text-red-800 dark:text-red-300">
        <p class="font-semibold uppercase">Atenção</p>
        <p class="text-gray-800 dark:text-gray-300">
    ...
    {{-- Capítulo 12.7 --}}
    <h2 id="cap-12.7" class="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">12.7 Exemplos de Uso</h2>

    <h3 id="cap-12.7-a" class="font-semibold mb-2 text-gray-900 dark:text-gray-100">cURL</h3>
    <p class="mb-2">
    ...
    <h3 id="cap-12.7-b" class="font-semibold mb-2 text-gray-900 dark:text-gray-100">Postman</h3>
    ...
    <h3 id="cap-12.7-c" class="font-semibold mb-2 text-gray-900 dark:text-gray-100">Power BI</h3>
    <p class="mb-2">
