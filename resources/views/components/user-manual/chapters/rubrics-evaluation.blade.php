<div class="max-w-4xl w-full xl:pe-24">
    ...
    <div class="space-y-2 mb-10">
        <p>
            ...
            como por exemplo <em>Domínio do tema</em>. Cada critério possui quatro níveis de desempenho,
            seguindo a escala do tipo Likert.
        </p>
        <p>
        ...
        <p>
            ...
            pelos membros da banca para avaliar trabalhos em grupo e/ou individualmente.
        </p>
    </div>
    ...
    <ul class="list-disc pl-6 mb-4 space-y-1">
        ...
        <li>Etiqueta de status (ativo/inativo)</li>
        <li>Botões de alterar e inativar</li>
    </ul>
    <p class="mb-2">
        O modal de criação/edição de rubricas contém:
    </p>
    <ul class="list-disc pl-6 mb-4 space-y-1">
        <li>
    ...
    <p class="mb-2">
        A ficha avaliativa é exibida em layout vertical, sem menu superior, para maior foco.
    ...
    <p class="mb-2">
        ...
        Insatisfatório, Regular, Bom ou Excelente.
