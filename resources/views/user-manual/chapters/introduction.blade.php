<div class="min-w-0 max-w-4xl w-full xl:pe-24 manual-content" :class="{ {{ $textSettings }} }">
    ...
    {{-- Capítulo 1.1 --}}
    <section>
        <h2 id="cap-1.1">1.1 Sobre o Sistema</h2>
        ...
        <h3 id="cap-1.1-a">Objetivos principais</h3>
        <ul>
    ...
    {{-- Capítulo 1.2 --}}
    <section>
        <h2 id="cap-1.2">1.2 Público-alvo</h2>
    ...
    {{-- Capítulo 1.3 --}}
    <section>
        <h2 id="cap-1.3">1.3 Sobre o SIMBAJU</h2>
    ...
    <section>
        {{-- Capítulo 1.4 --}}
        <section>
            <h2 id="cap-1.4">1.4 Sobre este Manual do Usuário</h2>

            <h3 id="cap-1.4-a">Finalidade do manual</h3>
            <p>
            ...
            <h3 id="cap-1.4-b">Conteúdo abordado</h3>
            <p>
            ...
            <h3 id="cap-1.4-c">Público e objetivo de uso</h3>
            <p>
        ...
        {{-- Capítulo 1.4.1 --}}
        <section>
            <h2 id="cap-1.4.1">1.4.1 Navegação</h2>

            <h3 id="cap-1.4.1-a">Navegação do manual</h3>
            <p>
            ...
            <h3 id="cap-1.4.1-b">Navegação do capítulo</h3>
            <p>
            ...
            <h3 id="cap-1.4.1-c">Voltar ao topo</h3>
            <p>
        ...
        {{-- Capítulo 1.4.2 --}}
        <section>
            <h2 id="cap-1.4.2">1.4.2 Preferências de leitura</h2>
            ...
            <h3 id="cap-1.4.2-a">Restaurar configurações</h3>
            <p>
            ...
            <h3 id="cap-1.4.2-b">Opções disponíveis</h3>
            <ul>
                <li>
...
<aside class="chapter-aside flex-1 hidden xl:block text-sm min-w-60 border-l border-gray-300 dark:border-gray-700" :class="{ 'sticky-chapter-aside': stickyNav, 'hidden-chapter-aside': !showChapterNav }">
    ...
    <nav class="leading-relaxed tracking-normal [word-spacing:0] text-gray-500 dark:text-gray-400 overflow-y-auto max-h-[calc(100vh-86px-2.5rem)] scrollbar-custom">
        ...
        <a href="#cap-1.4.1-c" class="sub-chapter-link block mb-3 !pl-10">
            Voltar ao topo
        </a>
