<div class="min-w-0 max-w-4xl w-full xl:pe-24 manual-content" :class="{ {{ $textSettings }} }">
    {{-- Capítulo 4 --}}
    <h1>4. Agenda de Avaliações</h1>

    {{-- Capítulo 4.1 --}}
    <section>
        <h2 id="cap-4.1">4.1 Visão geral da agenda</h2>
    ...
    {{-- Capítulo 4.2 --}}
    <section>
        <h2 id="cap-4.2">4.2 Interação com o calendário</h2>

        <h3 id="cap-4.2-a">Ações</h3>
        <p>
        ...
        <h3 id="cap-4.2-b">Alternância de visualização</h3>
        <p>
        ...
        <h3 id="cap-4.2-c">Navegação por datas</h3>
        <p>
        ...
        <h3 id="cap-4.2-d">Seleção de datas e horários</h3>
        <p class="mb-2">
...
@can('is-admin')
    {{-- Capítulo 4.3 --}}
    <section>
        <h2 id="cap-4.3">4.3 Agendamento de nova banca</h2>
...
@endcan
    ...
    {{-- Capítulo 4.4 --}}
    <section>
        <h2 id="cap-4.4">4.4 Visualização de bancas agendadas</h2>
        ...
        <h3 id="cap-4.4-a">Modo visualização</h3>
        <ul>
    ...
    <section>
        @if(auth()->user()->isAdmin())
            <h2 id="cap-4.5">4.5 Edição e cancelamento de agendamentos</h2>
    ...
    {{-- Capítulo 4.6 --}}
    <section>
        <h2 id="cap-4.6">4.6 Controle de acesso e permissões</h2>
    ...
    {{-- Capítulo 4.7 --}}
    <section>
        <h2 id="cap-4.7">4.7 Considerações importantes</h2>
        <ul>
